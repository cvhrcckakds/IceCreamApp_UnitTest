...
test('Butonlara tıklanca setMetodu doğru parametrelerle tetiklenir', async () => {
  ...
  const mockFn = jest.fn(); //taklit foks
  ...
  // setMethodu doğru parametreler çalıştı mı? ekle butonunu çalıştırmadan bu çalışmaz
